...
export default function SignupStep({ email, onChangeEmail, password, setPassword, onSubmit, isLoading, error }: SignupStepProps) {
    const [showPassword, setShowPassword] = useState(false);

    return (
        <div className="flex flex-col w-full" style={{ gap: '24px' }}>
            <div className="flex flex-col items-center w-full mb-1">
                {/* Reusing AuthHeader structure but manually strict for no Title */}
                {/* Or modify AuthHeader to allow no title? I can pass title="" and subtitle="Signup below". */}
                <AuthHeader title="Signup below" />
            </div>
                        ...
                        <div className="relative w-full">
                            <input
                                ...
                                style={{
                                    ...
                                    fontSize: !showPassword && password ? '16px' : '15px',
                                    color: '#0F172A',
