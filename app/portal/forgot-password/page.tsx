...
export default function ForgotPasswordPage() {
    // Lifted message state for global alerts
        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-white relative overflow-hidden">
            ...
            <div className="relative z-10 w-full flex justify-center px-4 md:px-0">
                <motion.div
                    ...
                    style={{
                        background: 'radial-gradient(80% 80% at 50% 30%, rgba(222, 243, 255, 0.5) 0%, rgba(255, 255, 255, 1) 70%)',
                ...
                >
                    ...
                    <ForgotPasswordFlow setMessage={setMessage} />
